...
A Globus Auth _service_ is a system that provides access to resources owned by users, and wants to provides access to those resources to <<developing-apps,_applications_>>, typically via a HTTP API.
