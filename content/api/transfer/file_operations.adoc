...
The "rename_supported" field indicates if the endpoint software supports
rename operations.  This does not necessarily mean the current user has
authorization to rename a file.
