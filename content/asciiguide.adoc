...
* check nested lists in conf file since they work in html4
* definition styling, add indent on "answers"?
* plus {plus} sign rendering broken; check conf?
...
* lists: ordered, nested works in html4, broken in html5
* lists: ordered, max nesting works in html4, broken in html5
