...
NOTE: This page refers to the current Globus CLI which is locally installed program. We also have a link:../hosted[reference for the legacy hosted CLI], which is accessed via SSH but will eventually be deprecated.
