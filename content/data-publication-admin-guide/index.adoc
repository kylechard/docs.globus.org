...
:publish_user_guide_url: http://docs.globus.org/data-publication-user-guide
...
http://docs.globus.org/resource-provider-guide[installed] and must have
http://docs.globus.org/resource-provider-guide/#sharing_section[Sharing
...
every handle generated helping to differentiate handles generated by
Globus Data Publication and if desired the specific collection the
dataset referred to by the handle resides in. The "Administrative
...
representation. The data placed in this field of the form should not
