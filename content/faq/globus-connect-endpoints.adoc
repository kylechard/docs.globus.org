...
If you experience issues activating an endpoint, it's often the case that one or more of the required ports is not open. Please see the link:../../resource-provider-guide/#open-tcp-ports_section[Resource Provider Guide] for infomration on required ports and configuring your firewall.
