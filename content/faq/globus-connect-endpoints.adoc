...
* link:../../how-to/howto-GCP-OSX/[Globus Connect Personal for Mac OS]
* link:../../how-to/howto-GCP-WIN/[Globus Connect Personal for Windows]
* link:../../how-to/howto-GCP-LINUX/[Globus Connect Personal for Linux]
