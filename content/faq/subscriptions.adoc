...
NOTE: You can also create a new managed endpoint using the `--managed-endpoint` option in in the link:../../cli/reference/endpoint-add/[endpoint-add] command.
