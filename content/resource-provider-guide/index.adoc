...
==== Mailing Lists
If you use Globus, then participating in one or more of the public email lists is an excellent way to keep in touch with your peers in the Globus Community. For questions about managing your Globus deployment, e.g. installing software for a Globus endpoint, configuring your firewall, and integrating your institution’s identity system, link:http://groups.google.com/a/globus.org/forum/#!forum/admin-discuss/subscribe[subscribe to the admin list]. For other inquiries and discussions, try the link:http://groups.google.com/a/globus.org/forum/#!forum/user-discuss/subscribe[user list] or link:http://groups.google.com/a/globus.org/forum/#!forum/developer-discuss/subscribe[developer list]. For more information on mailing lists, click https://www.globus.org/mailing-lists[here].
