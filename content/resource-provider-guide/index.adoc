...
globus-connect-server-io-setup (link to man page)
...
globus-connect-server-io-cleanup (link to man page)
...
globus-connect-server-id-setup (link to man page)
...
globus-connect-server-id-cleanup (link to man page)
...
globus-connect-server-web-setup (link to man page)
...
globus-connect-server-web-cleanup (link to man page)
