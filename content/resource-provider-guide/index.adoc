...
==== Globus Mailing List
Questions or issues that pertain to the Globus Toolkit components that are not relevant to the globus.org SaaS or PaaS offering should be submitted to the gt-user@lists.globus.org email list. Some examples of issues that should be directed to gt-user@lists.globus.org:

- using custom MyProxy PAM modules e.g. LDAP with Globus Connect Server
- GridFTP DSIs
- compiling custom software against the Globus Toolkit
- custom compiled versions of software in the Globus Toolkit
