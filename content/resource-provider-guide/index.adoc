...
description of every option can be found 
link:https://github.com/globus/globus-connect-server/blob/master/source/globus-connect-server.conf[here]. 

Note that any time you update settings in the 
