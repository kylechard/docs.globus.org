...
Please xref:where_to_ask_for_help[contact us] if you have problems understanding
...
xref:where_to_ask_for_help[Contact us] if you need assistance.
...
[NOTE]
A detailed 
description of each option can be found in the 
...
[[where_to_ask_for_help]]
=== Where to ask for help

==== Globus Toolkit Mailing List
Questions or issues that pertain to the Globus Toolkit components that are not relevant to the globus.org SaaS or PaaS offering should be submitted to the gt-user@lists.globus.org email list. 

==== Globus Forums
The link:https://support.globus.org/[Globus Forums] contain a wealth of knowledge about Globus services and software. It is often possible to find a solution to many common issues by simply browsing around the Forum and reading the articles there. For quickest results, the Globus Forums should be the first place you check when looking for a resolution to any issue you are having with Globus services or software.
