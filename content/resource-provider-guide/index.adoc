...
[[sharing_section]]
== [go-icon-pp]#Sharing#
Sharing is a feature that makes it simple to share particular folders on an 
existing xref:managed-endpoint-anchor[managed endpoint] with other Globus users. 
You can read about the details and benefits of Globus sharing link:https://globus.org/data-sharing[here]. 
Instructions on how to create a share on an existing managed endpoint can be found link:https://support.globus.org/entries/23602336[here].
