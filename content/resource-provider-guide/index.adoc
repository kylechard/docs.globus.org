...
==== Globus Forums
The link:https://support.globus.org/[Globus Knowledge Base] contain a wealth of knowledge about Globus services and software. It is often possible to find a solution to many common issues by simply browsing around the Knowledge Base and reading the articles there.
