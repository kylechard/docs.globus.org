...
:commercial-plans_url: http://www.globus.org/providers/provider-plans/commercial-subscription-inquiry/
:signup_url: http://www.globus.org/signup/
:transfer_url: http://www.globus.org/xfer/StartTransfer#/
...
link:{provider-plans_url}[Provider Plan subscribers] and 
link:{commercial-plans_url}[commercial subscribers].
...
* The use of the default port range is strongly recommended (read why xref:data_channel_traffic[here]).
...
You (or any user on your system who has signed up for a Globus account) should now be able to access the Globus endpoint you just created by navigating to the Globus 
...
link:{provider-plans_url}[*Provider Plan*] subscriptions come with a guaranteed support service level.
