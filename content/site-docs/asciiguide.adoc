...
NOTE: This is an example
      single-paragraph note with a link:/index.html[link] inside.
...
TIP: Tip with a link:/index.html[link] inside.

IMPORTANT: Important with a link:/index.html[link] inside.

WARNING: Warning with a link:/index.html[link] inside.

CAUTION: Caution with a link:/index.html[link] inside.
....
