...
[lead]#This text will be styled as a lead paragraph (i.e., larger font).# (check syntax)
...
+monospace phrase+ and le++tt++ers (check syntax)

+_monospace italic phrase_+ and le++__tt__++ers (check syntax)

+*monospace bold phrase*+ and le++**tt**++ers (check syntax)

+*_monospace bold italic phrase_*+ and le++**__tt__**++ers (check syntax)
